...
\title{Olivia's MEng thesis TK 125\&\^*!\&\^@*}
...
and Prof Ghobadi for introducing me to the world of networking research.
To all the developers of Rust and crossbeam for supporting my needs in high-performance parallel world, large sections of this thesis would not have been possible without the work they've put in, and the research it was based on. %cite, cite

Christina Meyer, Oomi Pammit, and Iris Hwang for being excellent friends and remote work buddies during this pandemic.
More generally, to all the women of EECS who quietly support each other.
\\

This timeout has lasted for far too long, so let's acknowledge TCP for establishing order on the internet. Thank you.
