...
An old algorithm, described as early as 1979\cite{fujimoto_parallel_2000, misra_distributed_1986} \manya{multiple citations are done with one \cite{X, Y}  command. please fix.}, is able to take these multiple in-order streams and safely return the next event.
