...
For context, Rotorsim is able to move 126Gbps on a laptop, more in \ref{}. \manya{missing ref}
...
All but Rust were chosen due to my familiarity with them, Rust chosen because recommended to me \manya{again, this is a non scientific reason. please omit. make sure you stay scientific and formal. mention the benefits of rust instead of saying it was recommenced to you.}.
...
\item The C implementation never took off, the library management system being difficult to manage, simple data structures like the heap requiring re-implementation.\manya{okay then omit something that you didn't do. no need to even mention it.}
\end{itemize}
