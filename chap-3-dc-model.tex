...
CLOS networks, or fat-trees, are a common topology in data-centers today. %cite Leiserson, Jupiter, Facebook
...
\begin{figure}[h]
    ...
    \label{fig:fat-tree}
    \caption{An example of a fat-tree topology from TODO} %TODO cite A scalable, commodity...
\end{figure}
