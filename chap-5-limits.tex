...
In this chapter we explore theoretical limits of simulators both in terms of speed, and what is possible

Throughout the chapter, the baseline model will consist of 4,773 actors comprised 128 racks connected to 37 backbone switches and 37 servers each through bidirectional 10Gbps links.
...
The main limiting factor in the feasability of simulations is how much memory it needs at any given moment.
Speed is typically not a concern since it is always possible, if frustrating, to wait longer, and disk space is cheap.
